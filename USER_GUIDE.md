...
4. **Access the application**:
   - Main application: http://localhost:41084
   - Management interface: http://localhost:9006/m/info
...
- **Health Check**: `http://localhost:9006/m/health`
  - Returns application health status
  - Includes database connectivity check

- **Info Endpoint**: `http://localhost:9006/m/info`
